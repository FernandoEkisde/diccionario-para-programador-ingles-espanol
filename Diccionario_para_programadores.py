...
# Diccionario de términos de programación con definiciones, ejemplos y traducciones
...
# Mensajes en español
mensajes_es = {
    "bienvenida": "¡Bienvenido/a al Diccionario de Código Viking! Nuestro programa te ofrece las siguientes funciones: Explorar el catálogo de palabras, opciones multilingües, búsqueda avanzada, contribuir con nuevos términos y conocer a nuestro equipo. ¿Qué te gustaría explorar primero?",
    "opciones": [
